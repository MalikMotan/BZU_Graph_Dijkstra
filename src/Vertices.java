...
//----------------------Setting up the vertices and their features as objects--------------------------------
//-------------------Using setName for setting the name of the vertex, setDim for setting up the locations(_dimensions_) for 
// vertices, and getX getY to get the coordinates for vertices when needed for performing actions-----------
